...
REQUIRED_COLS = [
    "patient_id", "episode_id", "ssi_classification", "p_none",
    "p_superficial", "p_deep", "p_organ_space", "confidence_zone",
    "review_required", "extracted_entities", "entity_snippets",
]
...
def make_row(**kwargs):
    d = {
        ...
        "days_post_op": 10, "procedure_code": "W38",
        "procedure_description": "Hip replacement", "procedure_type": "hip_total",
        "hospital_site": "SITE_A", "processing_mode": "text_only",
        "ssi_classification": "superficial",
        "p_none": 0.05, "p_superficial": 0.88, "p_deep": 0.05, "p_organ_space": 0.02,
        "confidence_zone": "auto_positive", "review_required": False,
        "extracted_entities": "DISCHARGE:affirmed", "entity_snippets": '"pus"',
        "ecdc_window_flag": "within_30d", "icd10_codes": "Z96.6", "validation_flag": "",
    }
    d.update(kwargs)
